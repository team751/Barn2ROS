...
(cl:defmethod ids-val ((m <ObstacleMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teb_local_planner-msg:ids-val is deprecated.  Use teb_local_planner-msg:ids instead.")
  (ids m))

(cl:ensure-generic-function 'orientations-val :lambda-list '(m))
(cl:defmethod orientations-val ((m <ObstacleMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teb_local_planner-msg:orientations-val is deprecated.  Use teb_local_planner-msg:orientations instead.")
  (orientations m))
