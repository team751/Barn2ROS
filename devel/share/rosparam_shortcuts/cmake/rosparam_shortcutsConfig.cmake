...
if("TRUE" STREQUAL "TRUE")
  set(rosparam_shortcuts_SOURCE_PREFIX /home/ubuntu/Barn2ROS/src/dependencies/rosparam_shortcuts)
  set(rosparam_shortcuts_DEVEL_PREFIX /home/ubuntu/Barn2ROS/devel)
  ...
  set(rosparam_shortcuts_INSTALL_PREFIX /home/ubuntu/Barn2ROS/install)
...
if(NOT "/home/ubuntu/Barn2ROS/src/dependencies/rosparam_shortcuts/include;/usr/include/eigen3 " STREQUAL " ")
  set(rosparam_shortcuts_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/Barn2ROS/src/dependencies/rosparam_shortcuts/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosparam_shortcuts' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Barn2ROS/src/dependencies/rosparam_shortcuts/${idir}'.  Ask the maintainer 'Dave Coleman <davetcoleman@gmail.com>' to fix it.")
    endif()
