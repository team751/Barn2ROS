...
if("TRUE" STREQUAL "TRUE")
  set(cheesy_drive_SOURCE_PREFIX /home/ubuntu/Barn2ROS/src/cheesy_drive)
  set(cheesy_drive_DEVEL_PREFIX /home/ubuntu/Barn2ROS/devel)
  ...
  set(cheesy_drive_INSTALL_PREFIX /home/ubuntu/Barn2ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cheesy_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/Barn2ROS/src/cheesy_drive/${idir}'.  Ask the maintainer 'sambaumgarten <sambaumgarten@todo.todo>' to fix it.")
    endif()
