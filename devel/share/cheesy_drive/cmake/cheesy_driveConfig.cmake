...
if("TRUE" STREQUAL "TRUE")
  set(cheesy_drive_SOURCE_PREFIX /Users/sambaumgarten/Barn2ROS/src/cheesy_drive)
  set(cheesy_drive_DEVEL_PREFIX /Users/sambaumgarten/Barn2ROS/devel)
  ...
  set(cheesy_drive_INSTALL_PREFIX /Users/sambaumgarten/Barn2ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cheesy_drive' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/Users/sambaumgarten/Barn2ROS/src/cheesy_drive/${idir}'.  Ask the maintainer 'sambaumgarten <sambaumgarten@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /Users/sambaumgarten/Barn2ROS/devel/lib;/Users/sambaumgarten/Barn2ROS/devel/lib;/Users/sambaumgarten/rosinstall/install_isolated/lib;/Users/sambaumgarten/controlit_workspace/devel/lib)
